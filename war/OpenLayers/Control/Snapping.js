...
OpenLayers.Control.Snapping = OpenLayers.Class(OpenLayers.Control, {
    ...
    /**
     * Property: layer
     * {<OpenLayers.JSONLayer.Vector>} The current editable layer.  Set at
     ...
     *
     * Valid options:
     * layer - {OpenLayers.JSONLayer.Vector} The editable layer.  Features from this
     *     layer that are digitized or modified may have vertices snapped to
     *     features from any of the target layers.
     * targets - {Array(Object | OpenLayers.JSONLayer.Vector)} A list of objects for
     ...
     * layer - {OpenLayers.JSONLayer.Vector} A target layer.  Features from this
     ...
     *
     * Parameters:
     * layer - {OpenLayers.JSONLayer.Vector}  The new editable layer.
     */
     ...
     *
     * Parameters:
     * layer - {<OpenLayers.JSONLayer.Vector>} A target layer.
     */
     ...
     *
     * Parameters:
     * layer - {<OpenLayers.JSONLayer.Vector>} The target layer to remove.
     */
