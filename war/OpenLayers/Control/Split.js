...
OpenLayers.Control.Split = OpenLayers.Class(OpenLayers.Control, {
    ...
    /**
     * APIProperty: layer
     * {<OpenLayers.JSONLayer.Vector>} The target layer with features to be split.
    ...
    /**
     * Property: source
     * {<OpenLayers.JSONLayer.Vector>} Optional source layer.  Any newly created
     ...
     *
     * Valid options:
     * layer - {OpenLayers.JSONLayer.Vector} The target layer.  Features from this
     *     layer will be split by new or modified features on the source layer
     *     or temporary sketch layer.
     * source - {OpenLayers.JSONLayer.Vector} Optional source layer.  If provided
     ...
     *
     * Parameters:
     * layer - {OpenLayers.JSONLayer.Vector}  The new source layer layer.  If
