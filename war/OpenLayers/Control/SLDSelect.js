 ...
 * Perform selections on WMS layers using Styled JSONLayer Descriptor (SLD)
 *
 * Inherits from:
 *  - <OpenLayers.Control>
 */
OpenLayers.Control.SLDSelect = OpenLayers.Class(OpenLayers.Control, {
    ...
    /**
     * APIProperty: layers
     * {Array(<OpenLayers.JSONLayer.WMS>)} The WMS layers this control will work
     *     on.
     */
    layers: null,
     ...
     *     type OpenLayers.JSONLayer.WMS.Post. If not provided, layers will
     ...
     *     Styled JSONLayer Descriptor (SLD).
     *
     * Parameters:
     ...
     *
     * Valid options:
     * layers - Array({<OpenLayers.JSONLayer.WMS>}) The layers to perform the
     *     selection on.
     */
     ...
     *
     * Parameters:
     * source - {<OpenLayers.JSONLayer.WMS>} The source layer on which the selection
     *     is performed.
     *
     * Returns:
     * {<OpenLayers.JSONLayer.WMS.Post>} A WMS Post layer since SLD selections can
     ...
     *
     * Parameters:
     * layer - {<OpenLayers.JSONLayer.WMS>}
    ...
    *
    * Parameters:
    * layer - {<OpenLayers.JSONLayer.WMS>} The layer for which to look up the
    *     geometry attributes.
    *
    * Returns:
   ...
   getGeometryAttributes: function(layer) {
     ...
     *
     * Parameters:
     * layers - {Array(<OpenLayers.JSONLayer.WMS>)}  The new set of layers on which
