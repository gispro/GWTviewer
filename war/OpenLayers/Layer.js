...
OpenLayers.Layer = OpenLayers.Class({
  ...
  // OPTIONS
    ...
    /**
     * Constructor: OpenLayers.JSONLayer
     *
     * Parameters:
    ...
    *
    * Parameters:
    * obj - {<OpenLayers.JSONLayer>} The layer to be cloned
    *
    * Returns:
    * {<OpenLayers.JSONLayer>} An exact clone of this <OpenLayers.JSONLayer>
    */
    clone: function (obj) {
