...
/**
 * Class: OpenLayers.JSONLayer.Text
 ...
 *     in the <OpenLayers.JSONLayer.Text> constructor) points to a tab delimited
...
OpenLayers.Layer.Text = OpenLayers.Class(OpenLayers.Layer.Markers, {
    ...
    /**
     * Constructor: OpenLayers.JSONLayer.Text
     * Create a text layer.
     * 
     * Parameters:
     * name - {String} 
     ...
     */
    destroy: function() {
        // Warning: JSONLayer.Markers.destroy() must be called prior to calling
        // clearFeatures() here, otherwise we leak memory. Indeed, if
        // JSONLayer.Markers.destroy() is called after clearFeatures(), it won't be
