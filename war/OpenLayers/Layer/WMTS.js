...
/**
 * Class: OpenLayers.JSONLayer.WMTS
...
OpenLayers.Layer.WMTS = OpenLayers.Class(OpenLayers.Layer.Grid, {
    ...
    /**
     * Constructor: OpenLayers.JSONLayer.WMTS
     * Create a new WMTS layer.
     *
     * Example:
     * (code)
     * var wmts = new OpenLayers.JSONLayer.WMTS({
     *     name: "My WMTS JSONLayer",
     ...
     * 
     * Returns:
     * {<OpenLayers.JSONLayer.WMTS>} An exact clone of this <OpenLayers.JSONLayer.WMTS>
     */
    clone: function(obj) {
        if (obj == null) {
