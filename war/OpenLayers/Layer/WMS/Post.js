...
/**
 * Class: OpenLayers.JSONLayer.WMS.Post
 * Instances of OpenLayers.JSONLayer.WMS.Post are used to retrieve data from OGC
 * Web Mapping Services via HTTP-POST (application/x-www-form-urlencoded). 
 * Create a new WMS layer with the <OpenLayers.JSONLayer.WMS.Post> constructor.
 *
 * Inherits from:
 *  - <OpenLayers.JSONLayer.WMS>
 */
OpenLayers.Layer.WMS.Post = OpenLayers.Class(OpenLayers.Layer.WMS, {
    ...
    /**
     * Constructor: OpenLayers.JSONLayer.WMS.Post
     * Creates a new WMS layer object.
     *
     * Example:
     * (code)
     * var wms = new OpenLayers.JSONLayer.WMS.Post(
     *  "NASA Global Mosaic",
