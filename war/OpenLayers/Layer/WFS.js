...
/**
 * Class: OpenLayers.JSONLayer.WFS
 * *Deprecated*.  To be removed in 3.0.  Instead use OpenLayers.JSONLayer.Vector
...
OpenLayers.Layer.WFS = OpenLayers.Class(
  OpenLayers.Layer.Vector, OpenLayers.Layer.Markers, {
    ...
    /**
     * Constructor: OpenLayers.JSONLayer.WFS
     *
     * Parameters:
     * name - {String} 
     * url - {String} 
     ...
     * 
     * Returns:
     * {<OpenLayers.JSONLayer.WFS>} An exact clone of this OpenLayers.JSONLayer.WFS
     */
    clone: function (obj) {
