...
/**
 * Class: OpenLayers.JSONLayer.MapServer.Untiled
 * *Deprecated*.  To be removed in 3.0.  Instead use OpenLayers.JSONLayer.MapServer
 *     and pass the option 'singleTile' as true.
 * 
 * Inherits from: 
 *  - <OpenLayers.JSONLayer.MapServer>
 */
OpenLayers.Layer.MapServer.Untiled = OpenLayers.Class(OpenLayers.Layer.MapServer, {
    ...
    /**
     * Constructor: OpenLayers.JSONLayer.MapServer.Untiled
     *
     * Parameters:
     * name - {String} 
     * url - {String} 
     ...
     *
     * Returns:
     * {<OpenLayers.JSONLayer.MapServer.Untiled>} An exact clone of this layer
     */
    clone: function (obj) {
