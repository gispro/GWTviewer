...
/**
 * Class: OpenLayers.JSONLayer.ArcIMS
 * Instances of OpenLayers.JSONLayer.ArcIMS are used to display data from ESRI ArcIMS
 *     Mapping Services. Create a new ArcIMS layer with the <OpenLayers.JSONLayer.ArcIMS>
 *     constructor.
 * 
 * Inherits from:
 *  - <OpenLayers.JSONLayer.Grid>
 */
OpenLayers.Layer.ArcIMS = OpenLayers.Class(OpenLayers.Layer.Grid, {
    ...
    /**
     * APIProperty: name
     * {String} JSONLayer name.  Default is "ArcIMS".
     */
    name: "ArcIMS",
    ...
    /**
     * Constructor: OpenLayers.JSONLayer.ArcIMS
     * Create a new ArcIMS layer object.
     *
     * Example:
     * (code)
     * var arcims = new OpenLayers.JSONLayer.ArcIMS(
     *     "Global Sample",
     ...
     *
     * Returns:
     * {<OpenLayers.JSONLayer.ArcIMS>} An exact clone of this layer
     */
    clone: function (obj) {
