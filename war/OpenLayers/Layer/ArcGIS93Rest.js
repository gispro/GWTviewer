...
/**
 * Class: OpenLayers.JSONLayer.ArcGIS93Rest
 * Instances of OpenLayers.JSONLayer.ArcGIS93Rest are used to display data from
 *     ESRI ArcGIS Server 9.3 (and up?) Mapping Services using the REST API.
 *     Create a new ArcGIS93Rest layer with the <OpenLayers.JSONLayer.ArcGIS93Rest>
...
OpenLayers.Layer.ArcGIS93Rest = OpenLayers.Class(OpenLayers.Layer.Grid, {
    ...
    /**
     * Constructor: OpenLayers.JSONLayer.ArcGIS93Rest
     * Create a new ArcGIS93Rest layer object.
     *
     * Example:
     * (code)
     * var arcims = new OpenLayers.JSONLayer.ArcGIS93Rest("MyName",
    ...
    /**
         ...
         *
         * Returns:
         * {<OpenLayers.JSONLayer.ArcGIS93Rest>} An exact clone of this layer
         */
    clone: function (obj) {
