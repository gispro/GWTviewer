...
/**
 * Class: OpenLayers.JSONLayer.FixedZoomLevels
 ...
 *    is set up. Which would be a big problem getResolution() in JSONLayer, since
 ...
 *    the resolutions[] array, we call OpenLayers.JSONLayer.getExent(), passing in
 *    the desired resolution. With this extent, we then call getZoomForExtent() 
 * 
 * 
 *   Whenever you implement a layer using OpenLayers.JSONLayer.FixedZoomLevels,
...
OpenLayers.Layer.FixedZoomLevels = OpenLayers.Class({
  ...
  /********************************************************/
    ...
    /**
     * Constructor: OpenLayers.JSONLayer.FixedZoomLevels
    ...
    initResolutions: function() {
        ...
        // should be set as a default on the JSONLayer.WMS class. If someone
