 ...
 * layers (<OpenLayers.JSONLayer>) to the map.
 */
OpenLayers.Map = OpenLayers.Class({
    ...
    /**
     * APIProperty: layers
     * {Array(<OpenLayers.JSONLayer>)} Ordered list of layers in the map
     */
    layers: null,
     ...
     * {<OpenLayers.JSONLayer>} The currently selected base layer.  This determines
  ...
  // Options
     ...
     *
     * Returns:
     * {Array(<OpenLayers.JSONLayer>)} A list of layers matching the given criteria.
     ...
     *
     * Returns:
     * {Array(<OpenLayers.JSONLayer>)} A list of layers matching the given name.
     *     An empty array is returned if no matches are found.
     */
     ...
     *
     * Returns:
     * {Array(<OpenLayers.JSONLayer>)} A list of layers matching the given class.
     *     An empty array is returned if no matches are found.
     */
  ...
  /********************************************************/         
     ...
     *
     * Returns:
     * {<OpenLayers.JSONLayer>} The JSONLayer with the corresponding id from the map's
    ...
    *
    * Parameters:
    * layers - {Array(<OpenLayers.JSONLayer>)}
    */    
     ...
     *     the default OpenLayers.JSONLayer class's destroy() function
     ...
     * 
     * Parameters:
     * newBaseLayer - {<OpenLayers.JSONLayer>}
     */
  ...
  /*                 JSONLayer Options                        */
  /*                                                      */
  /*    Accessor functions to JSONLayer Options parameters    */
  /*                                                      */
  /********************************************************/
  ...
  //
     ...
     * 
     * Returns:
     * {<OpenLayers.Pixel>} JSONLayer Pixel translated into ViewPort Pixel
     *                      coordinates
     */
     ...
     * 
     * Returns:
     * {<OpenLayers.Pixel>} ViewPort Pixel translated into JSONLayer Pixel
     *                      coordinates
     */
