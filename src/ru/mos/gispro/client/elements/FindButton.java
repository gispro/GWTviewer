...
public class FindButton extends ToolStripButton
{
    ...
    public static       String URL_FIND_NOMER_DOROG = "";
	...
	public static       String FIND_NOMER_DOROG     = "Инвентарный номер дорог";
	...
	public FindButton()
    {
        ...
        URL_FIND_NOMER_DOROG = GWTViewer.config.findNomerDorog    ();

        if (URL_FIND_STREETS.trim().length() == 0)
            FIND_ULITSI = null;
        if (URL_FIND_TITUL_DOROG.trim().length() == 0)
            FIND_TITUL_DOROG = null;
        if (URL_FIND_NOMER_DOROG.trim().length() == 0)
        	FIND_NOMER_DOROG = null;
		...
		this.addClickHandler(new ClickHandler()
        {
			...
			public void findTask(String where, final String what)
			{
			    ...
			    else if ((FIND_NOMER_DOROG != null) && FIND_NOMER_DOROG.equals(where))
			    	url = URL_FIND_NOMER_DOROG;
...
//				com.google.gwt.user.client.Window.alert(findAttrGrid.getDataAsRecordList().isEmpty() + "");
			...
			public void onClick(ClickEvent event) {
				...
				if (winModal == null) {
                    ...
                    if (FIND_NOMER_DOROG != null)
    					whereListBox.addItem(FIND_NOMER_DOROG);
