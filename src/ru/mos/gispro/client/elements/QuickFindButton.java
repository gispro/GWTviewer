...
//        System.out.println ("findTask : " + url);
...
//                    System.out.println ("findTask : 0 - resCount = " + resCount);
...
//                        System.out.println ("findTask : 0." + i);
                        for (int j = 0; j < keys.length(); j++)
                        {
//                            System.out.println ("findTask : 0." + i + "." + j);
...
//                            	System.out.println ("findTask : 0." + i + "." + j + " - " + find.results().get(i).value() + ", class_id = " + find.results().get(i).attributesByKey(ALIAS_CLASS_ID));
...
//                        	System.out.println ("findTask : 0." + i + ".99999999");
...
//				}
	...
	public QuickFindButton(final TextItem textBox)
    {
		...
		this.addClickHandler(new ClickHandler()
        {
            ...
            {
				System.out.println ("QuickFindButton.onClick");
				GeometryManager.clearGeometry();
