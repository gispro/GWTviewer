...
{
    public    final   static    int                  WIDTH                   = 690;  // 245; // 
    public    final   static    int                  HEIGHT                  = 600;  // 240; // 
    ...
    private           static    BaseMapRecord[]      records                 = {
           ...
           , null, null,
            ...
            new BaseMapRecord("\u0042\u0069\u006E\u0067\u0020\u004D\u0061\u0070\u0020\u041A\u0430\u0440\u0442\u0430",
                              "baseMapBingStreet.png", "BingMapStreets" ),
            new BaseMapRecord("\u0042\u0069\u006E\u0067\u0020\u004D\u0061\u0070\u0020\u0413\u0438\u0431\u0440\u0438\u0434",
                              "baseMapBingHybrid.png"   , "BingMapHybrid"  ),
            new BaseMapRecord("\u0042\u0069\u006E\u0067\u0020\u004D\u0061\u0070\u0020\u0421\u043F\u0443\u0442\u043D\u0438\u043A",
                              "baseMapBingSatellite.png", "BingMapSatellite")
    };
...
//        tileGrid.setBorder("2px solid #9C9C9C");
        ...
        checkboxItem.addChangeHandler(new ChangeHandler()
        {
              ...
              {
//            	  System.out.println (" checkboxItem.getValueAsBoolean() : " + checkboxItem.getValueAsBoolean());
            	  if (!checkboxItem.getValueAsBoolean())
            		  removeBaseMap();
            	  else if (tileGrid.getSelectedRecord() != null)
                      setBaseMap (tileGrid.getSelectedRecord().getAttribute(ATTRIBUTE_TITLE));
            	  else
    ...
    //~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
    public void setBaseMapName(String name)
    {
    	BaseMapRecord  record = records[0];
    	record.setName(name);
    }
    //~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
}
