...
public class JSONConfig extends JavaScriptObject
{
	...
	public final native String                     hintJSON                  () /*-{ return this.hintJSON;                 }-*/;
	public final native String                     imageFormat               () /*-{ return this.imageFormat;              }-*/;

	public final native String                     urlHelp                   () /*-{ return this.urlHelp;                  }-*/;

	public final native String                     legendsURL_old            () /*-{ return this.legendsURL_old;           }-*/;
	public final native String                     legendsURL_new            () /*-{ return this.legendsURL_new;           }-*/;
	public final native String                     legendsServlet_old        () /*-{ return this.legendsURLServlet_old;    }-*/;
	public final native String                     legendsServlet_new        () /*-{ return this.legendsURLServlet_new;    }-*/;
    ...
    public final native String                     findNomerDorog            () /*-{ return this.urlFindNomerDorog;        }-*/;
    public final native String                     getURLRoadSoft            () /*-{ return this.urlRoadSoft;              }-*/;

    public final native String                     getLegendsURL             () /*-{ return this.LegendsURL;               }-*/;
    public final native String                     getBaseMapURL             () /*-{ return this.baseMapURL;               }-*/;
    public final native String                     getBaseMapName            () /*-{ return this.baseMapName;              }-*/;
